...
public class GlassMaterial implements Material {
    ...
    /***
     * Default Constructor with constant color white and n1 set to 1.0 and n2 set to 1.5
     */
     ...
     */
    public GlassMaterial(double n2, Sampler texture) {
     ...
     * @param filename
     */
    public GlassMaterial(double n2, String filename) {
